<div class="container">
                ...
                <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Groups</b> <a class="float-right">1,322</a>
                        </li>
                        <li class="list-group-item">
                    ...
                    <a href="{{ route('group.edit', $group->id) }}" class="btn btn-primary btn-block"><b>Edit</b></a>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-6">
    ...
    <livewire:student.create :group="$group" />
    <livewire:student.show :group="$group" />
</div>
